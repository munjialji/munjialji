...
export default class App extends Component {
  ...
  render() {
    ...
    else if (this.state.locationResult === null) {
      return (
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          <View style={{ marginTop: 20, alignItems: 'center', flexDirection: 'row' }}>
            ...
            <CircularProgress
              size={100}
              progressWidth={30}
              percentage={this.state.airkorea_dust_type == 1 ? this.state.dataSource.fine_dust / 2 : this.state.dataSource.ultra_fine_dust / 2}
              donutColor={'red'}
            >
              <Text style={{ fontSize: 18, color: 'black' }}>
                {this.state.airkorea_dust_type == 1 ? this.state.dataSource.fine_dust : this.state.dataSource.ultra_fine_dust}
              </Text>
              <Text style={{ fontSize: 18, color: 'black' }}>나쁨</Text>
            </CircularProgress>
            <TouchableOpacity
              onPress={() => this.setState({
